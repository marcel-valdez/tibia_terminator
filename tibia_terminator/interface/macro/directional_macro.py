...
class DirectionalMacro():
    ...
    __rotation_threshold_secs: int = 60
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.__rotation_threshold_secs = _config.rotation_threshold_secs
