...
class KnightPotionKeeper:
    ...
    def drink_mana_potion(self, char_status: CharStatus):
        threshold_ms = self.update_last_threshold(self.get_threshold_ms(
            char_status.mana,
            self.mana_config,
        ))
    ...
    def get_threshold_ms(self, stat_value: int, stat_config: StatConfig) -> int:
