...
class EmergencyMagicShieldKeeper(MagicShieldKeeper):
    ...
    def should_cast(self, char_status):
        return ((self.emergency_reporter.is_in_emergency()
                 or self.tank_mode_reporter.is_tank_mode_on()) and
                (char_status.magic_shield_level <= self.magic_shield_treshold
    ...
    def should_cast_cancel(self, char_status):
        ...
        if (not (self.emergency_reporter.is_in_emergency()
                 or self.tank_mode_reporter.is_tank_mode_on())
